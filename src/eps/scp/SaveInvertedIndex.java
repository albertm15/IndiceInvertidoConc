...
public class SaveInvertedIndex implements Runnable{
    ...
    public SaveInvertedIndex(String indexDirectory, ConcurrentSkipListMap<String, ConcurrentSkipListSet<Location>> Hash){
    ...
    {
        try {
            ConcurrentSkipListSet<Location> locations = Hash.get(key);
